...
3. **私人数据留在用户自己电脑**——开源包不含你的持仓；`assets/` 请勿提交到公开仓库。投资问答沉淀在 **`assets/fund-knowledge.md`（基金知识库）**，**不要**写 `QA_Log.md`（看板不读 QA_Log）。
...
0. 若用户尚未安装 skill，提示执行：`npx skills@latest add rebecha1227-a11y/fund-lab`
